...
#include <slicersofatoolbox/PickingInteractor.h>
...
template<class DataTypes>
sofa::Index PickingInteractor<DataTypes>::findCollidingElem(const sofa::type::Vec3& pos) const
{
    ...
    sofa::helper::ReadAccessor<sofa::Data <VecCoord> > destPositions = mstate->read(sofa::core::vec_id::read_access::position);
...
void PickingInteractor<DataTypes>::handleEvent(sofa::core::objectmodel::Event *event)
{
    if (dynamic_cast<sofa::simulation::AnimateEndEvent*>(event))
    {
        ...
        else
        {
            ...
            sofa::helper::WriteAccessor<sofa::Data <sofa::defaulttype::Vec3Types::VecCoord> > positions = mstate->write(sofa::core::vec_id::write_access::position);
