...
class SLICERSOFATOOLBOX_API PickingInteractor : public sofa::gui::component::performer::MouseInteractor<DataTypes> {
public:
    ...
    sofa::Data< sofa::helper::OptionsGroup > d_pickingType;
    sofa::Data< double > d_springStiffness;
    sofa::Data< unsigned > d_reactionTime;

    sofa::SingleLink<PickingInteractor, sofa::core::CollisionModel, sofa::BaseLink::FLAG_STOREPATH | sofa::BaseLink::FLAG_STRONGLINK> l_destCollisionModel;
    ...
    sofa::Index findCollidingElem(const sofa::type::Vec3& pos) const;
