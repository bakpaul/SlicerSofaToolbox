...
#include <slicersofatoolbox/EngineToMState.h>
...
void EngineToMState<DataTypes>::applyTopologyChanges() {
    ...
    sofa::helper::WriteAccessor<sofa::Data <VecCoord> > X = *l_state->write(sofa::core::vec_id::write_access::position);
    sofa::helper::WriteAccessor<sofa::Data <VecCoord> > Xfree = *l_state->write(sofa::core::vec_id::write_access::freePosition);
    sofa::helper::WriteAccessor<sofa::Data <VecCoord> > X0 = *l_state->write(sofa::core::vec_id::write_access::restPosition);
